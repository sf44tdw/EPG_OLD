...
public class EqualsChecker<T> {
    ...
    /**
     * @return targetがnullを評価したときの値がfalseならばtrue。
     */
    private boolean null_testEquals(T target) {
    ...
    /**
     * @return targetがtargetを評価したときの値がtrueならばtrue。
     */
    private boolean reflexive_testEquals(T target) {
